...
impl Materials {
  fn new() -> Self {
    ...
    utils::load_csv(
      utils::translations_path("materials-generation-rules.csv"),
      |MaterialGenerationRule {
         rule,
         state,
         prefix,
         suffix,
    ...
    utils::load_csv(
      utils::translations_path("materials-nouns.csv"),
      |MaterialNoun {
         rules,
         noun,
         noun_translation,
    ...
    utils::load_csv(
      utils::translations_path("materials-adjectives.csv"),
      |MaterialAdjective {
         source_noun,
         adjective,
