...
pub struct OffsetsValues {
  ...
  pub addchar: Option<usize>,
  pub addchar_flag: Option<usize>,
  pub draw_nineslice: Option<usize>,
  pub draw_horizontal_nineslice: Option<usize>,
...
pub struct SymbolsValues {
  ...
  pub draw_nineslice: Option<Vec<String>>,
  pub draw_horizontal_nineslice: Option<Vec<String>>,
